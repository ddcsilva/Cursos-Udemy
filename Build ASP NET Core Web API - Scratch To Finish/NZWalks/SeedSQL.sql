USE [NZWalksDB]
GO
DELETE FROM [NZWalksDB].[dbo].[Regioes];
GO
DELETE FROM [NZWalksDB].[dbo].[Dificuldades];
GO
DELETE FROM [NZWalksDB].[dbo].[Trilhas];
GO
INSERT [dbo].[Dificuldades] ([Id], [Nome]) VALUES (N'f808ddcd-b5e5-4d80-b732-1ca523e48434', N'Fácil')
GO
INSERT [dbo].[Dificuldades] ([Id], [Nome]) VALUES (N'54466f17-02af-48e7-8ed3-5a4a8bfacf6f', N'Moderado')
GO
INSERT [dbo].[Dificuldades] ([Id], [Nome]) VALUES (N'ea294873-7a8c-4c0f-bfa7-a2eb492cbf8c', N'Difícil')
GO
INSERT [dbo].[Regioes] ([Id], [Codigo], [Nome], [ImagemUrl]) VALUES (N'906cb139-415a-4bbb-a174-1a1faf9fb1f6', N'NSN', N'Nelson', N'https://images.pexels.com/photos/13918194/pexels-photo-13918194.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
GO
INSERT [dbo].[Regioes] ([Id], [Codigo], [Nome], [ImagemUrl]) VALUES (N'f7248fc3-2585-4efb-8d1d-1c555f4087f6', N'AKL', N'Auckland', N'https://images.pexels.com/photos/5169056/pexels-photo-5169056.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
GO
INSERT [dbo].[Regioes] ([Id], [Codigo], [Nome], [ImagemUrl]) VALUES (N'14ceba71-4b51-4777-9b17-46602cf66153', N'BOP', N'Bay Of Plenty', NULL)
GO
INSERT [dbo].[Regioes] ([Id], [Codigo], [Nome], [ImagemUrl]) VALUES (N'6884f7d7-ad1f-4101-8df3-7a6fa7387d81', N'NTL', N'Northland', NULL)
GO
INSERT [dbo].[Regioes] ([Id], [Codigo], [Nome], [ImagemUrl]) VALUES (N'f077a22e-4248-4bf6-b564-c7cf4e250263', N'STL', N'Southland', NULL)
GO
INSERT [dbo].[Regioes] ([Id], [Codigo], [Nome], [ImagemUrl]) VALUES (N'cfa06ed2-bf65-4b65-93ed-c9d286ddb0de', N'WGN', N'Wellington', N'https://images.pexels.com/photos/4350631/pexels-photo-4350631.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
GO
Insert into [NZWalksDB].[dbo].[Trilhas]
(Id, Nome, Descricao, DistanciaEmKm, ImagemUrl, DificuldadeId, RegiaoId)
values
